...
@Component({
  selector: 'app-radiologue', // Sélecteur du composant
  templateUrl: './radiologue.component.html', // Template HTML associé
  styleUrls: ['./radiologue.component.css'], // Fichier de style associé
  imports: [CommonModule], //Angular de base
...
export class RadiologueComponent implements OnInit {
  ...
  redigerBilan(): void {
    this.router.navigate(['/compterendu']); // Utilisez la méthode navigate
  }
